<template>
    <div>
        ...
        <fatal-error v-if="error">Unfortunately we cannot proceed</fatal-error>
            ...
            >
                ...
                <div v-else>
                    <div v-if="alreadyReviewed">
                        ...
                        <h3>
                            Maybe you've already left a review for this booking.
                        </h3>
                    </div>
                    <div v-else>
                        ...
                        <div class="form-group">
                            <label for="content" class="text-muted"
                                >Describe your experience, it's good?</label
                            >
                            <textarea
                                name="content"
                                cols="30"
...
export default {
    ...
    async created() {
        ...
        // THIS CODE WORKS LIKE ABOVE!, but represent in async/await version
        // 1. if review already exists (in reviews table by id)
        try {
            this.existingReview = (
